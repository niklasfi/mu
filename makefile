...
OBJECTS = HypothesisNode.o PartialTranslation.o aStar.o aStarElement.o ptree.o cost.o decoder.o hyprefpair.o bleu.o mert2.o wordinfo.o sentenceinfo.o
...
default: all
all:  translate.exe phraseextract.exe optimize.exe
